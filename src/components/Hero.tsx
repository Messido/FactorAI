...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-factor-black py-20">
      ...
      >
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-factor-red/10 blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-factor-red/5 blur-3xl"></div>
      </div>
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          <div className="bg-factor-red/20 backdrop-blur-sm px-4 py-1.5 rounded-full mb-8 animate-fade-in">
