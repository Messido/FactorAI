...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (dotRef.current) {
        ...
        dotRef.current.style.transform = `translate(${dotXPos}px, ${dotYPos}px) scale(${
          1 + Math.abs(dotXPos / 20)
        })`;
      }
    };
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-factor-black py-20"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <TypingAnimation className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            We craft digital experiences that transform brands
          </TypingAnimation>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10 animate-fade-in animate-delay-500">
            Factor helps ambitious brands elevate their digital presence through
            strategic creativity and technical excellence.
          </p>
